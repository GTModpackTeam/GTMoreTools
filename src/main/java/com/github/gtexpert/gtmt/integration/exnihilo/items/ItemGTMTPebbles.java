 ...
 */
package com.github.gtexpert.gtmt.integration.exnihilo.items;
...
public class ItemGTMTPebbles extends Item implements IHasModel {

    public ItemGTMTPebbles(String registryName, String translationKey) {
    ...
    public void getSubItems(@Nullable CreativeTabs tab, @Nonnull NonNullList<ItemStack> list) {
        if (tab != null && isInCreativeTab(tab)) {
            for (GTPebbles pebble : GTPebbles.VALUES) {
                list.add(new ItemStack(ExNihiloItems.pebbleItem, 1, pebble.ordinal()));
            }
        }
    }
