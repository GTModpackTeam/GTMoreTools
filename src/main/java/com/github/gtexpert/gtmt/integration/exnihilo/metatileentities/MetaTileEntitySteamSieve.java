...
import com.github.gtexpert.gtmt.integration.exnihilo.ExNihiloModule;
...
public class MetaTileEntitySteamSieve extends SteamMetaTileEntity {
    ...
    public MetaTileEntitySteamSieve(ResourceLocation metaTileEntityId, boolean isHighPressure) {
        super(metaTileEntityId, ExNihiloRecipeMaps.SIEVE_RECIPES, Textures.SIFTER_OVERLAY, isHighPressure);
    }
    ...
    protected IItemHandlerModifiable createExportItemHandler() {
        return new NotifiableItemStackHandler(this, 42, this, true);
    }
        ...
        ModularUI.Builder builder = new ModularUI.Builder(GuiTextures.BACKGROUND_STEAM.get(this.isHighPressure), 176,
                192 + 18 * 2)
                        ...
                        .progressBar(workableHandler::getProgressPercent, 25, 68, 20, 20,
                                ...
                                ProgressWidget.MoveType.VERTICAL_DOWNWARDS, workableHandler.getRecipeMap())
                        ...
                        .bindPlayerInventory(player.inventory, GuiTextures.SLOT_STEAM.get(this.isHighPressure), 7,
                                109 + 18 * 2);
