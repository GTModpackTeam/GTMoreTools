 ...
 *
 * <p>
 * TiC natively names levels 0–4 (Wood, Stone, Iron, Diamond, Cobalt).
 * GTMT automatically assigns names for levels 5 and above based on the first
 * GT material encountered at each level. Registrations made here take priority
 * over those auto-assigned names.
 *
 * <p>
...
public final class HarvestLevels {
    ...
    /**
     * Returns an unmodifiable view of the harvest-level name registry.
     * Used internally by {@code TiCMaterials} when applying names to TiC.
     */
     ...
     *
     * <p>
     * Call this before GTMT's {@code registerBlocks} phase to override the name
     * GTMT would otherwise auto-assign from the first GT material seen at that level.
     *
     * <p>
    ...
    /**
     * Fills a harvest level name only if not already registered externally.
     * Called internally by {@code TiCMaterials} during GT material processing.
     */
