...
public final class TraitRegistry {
    ...
    public static final class TraitEntry {
        ...
        public TraitEntry(AbstractTrait trait, @Nullable String slot) {
            this.trait = trait;
            this.slot = slot;
        }
    ...
    /**
     * Predicate evaluated against a GT material and its {@link ToolProperty} to decide
     * whether a trait should be assigned.
     */
    @FunctionalInterface
    ...
    public static final class PropertyEntry {
        ...
        public PropertyEntry(TraitCondition condition, AbstractTrait trait, @Nullable String slot) {
    ...
    static {
        ...
        registerCompositionTrait(Materials.Gold, GTMTTraits.MOONLIT, "head");
        registerCompositionTrait(Materials.Platinum, GTMTTraits.MOONLIT, "head");
        registerCompositionTrait(Materials.Palladium, GTMTTraits.MOONLIT, "head");
        registerCompositionTrait(Materials.Iridium, GTMTTraits.MOONLIT, "head");
    }

    /**
     * Returns an unmodifiable view of the composition-trait registry.
     * Used internally by {@code TiCMaterials} when assigning traits.
     */
     ...
     *
     * <p>
     * Any GT material whose direct composition contains {@code component} will have
     * {@code trait} added to {@code slot} on its TiC material.
     *
     * <p>
    ...
    static {
        ...
        registerPropertyTrait(
                ...
                GTMTTraits.UNBREAKABLE, null);
    }

    /**
     * Returns an unmodifiable view of the property-trait registry.
     * Used internally by {@code TiCMaterials} when assigning traits.
     */
     ...
     *
     * <p>
     * When GTMT processes a GT material, {@code condition} is evaluated against the
     * material and its {@link ToolProperty}. If it returns {@code true}, {@code trait}
     * is added to {@code slot}.
     *
     * <p>
    ...
    public static AbstractTrait getOrCreateEnchantmentTrait(Enchantment enchantment, int level) {
        return GTMTTraits.getOrCreateEnchantmentTrait(enchantment, level);
    }
