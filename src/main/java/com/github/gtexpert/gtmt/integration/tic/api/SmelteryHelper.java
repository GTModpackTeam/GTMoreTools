...
import com.github.gtexpert.gtmt.integration.tic.TiCSmeltery;

/**
 * Helper for registering TiC Smeltery melting recipes for GT materials.
 *
 * <p>
 * Recipes registered here use the same OreDict-name derivation as GTMT's
 * auto-generated recipes, so they integrate consistently with the rest of
 * GTMT's smeltery support.
 *
 * <p>
...
public final class SmelteryHelper {
     ...
     *                 (use {@link slimeknights.tconstruct.library.materials.Material#VALUE_Ingot} etc.)
    ...
    /**
     * Returns the TiC smeltery temperature GTMT derives from a GT material's blast temperature.
     * Use this to match the temperature GTMT assigned to the base material's other forms.
     *
     * <ul>
